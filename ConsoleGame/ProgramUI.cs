...
namespace ConsoleGame
{
    public class ProgramUI
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("Shoot, the hallway branches off. The left keeps going deeper in another\n" +
                "straight line and the right seems to turn after walking down a bit\n" +
                "1. Left\n" +
                "2. Right\n");
            string response = Console.ReadLine();
            switch (response)
